...
const SalesForm = ({ form, onSave, isLoading, type }) => {
    ...
    <>
      <Card className="mb-4">
        ...
        >
            ...
            <Stepper.Step label="Step 1">
              <div className="flex flex-wrap gap-6 ">
                ...
                <Select
                  ...
                  data={customers}
                  onChange={(value) =>
                    form.setFieldValue(parseInt('partnerId', parseInt(value)))
                  }
          ...
          {/* </div> */}
          <div className="flex justify-end gap-10" style={{ marginTop: 20 }}>
            {active < 1 && (
              <>
                <Button
