...
import { ReceiveFormData, receiveSchama } from '../schema/received.shema'
...
const Ship = () => {
  ...
  const form = useForm<ReceiveFormData>({
    ...
    initialValues: {
      ...
      receivedItems: [{ quantity: 0, purchasedItemsId: '', key: randomId() }],
    },
    validate: zodResolver(receiveSchama),
  })
  ...
  const onSave = (values: ReceiveFormData) => {
    values.receivedDate = new Date(values.receivedDate)
    mutateAsync(values)
  }
